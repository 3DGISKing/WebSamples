<template>
  <intersect @enter="onEnter" @leave="onLeave">
    <section class="project-section project-slider">
      <div class="project-slider__container" ref="container">
        <div class="project-slider__slider" ref="slider">
          <div
            class="project-slider__element"
            v-for="(element, index) in data.elements"
            :key="index"
            ref="elements"
          >
            <img :src="element.source" :alt="element.title" class="project-slider__element-source">
          </div>
        </div>
      </div>

      <div class="container project-slider__nav-container">
        <nav class="project-slider__nav">
          <button
            ref="previous"
            role="button"
            aria-label="Previous"
            @click.prevent="onElementsLeft"
            class="action-button project-slider__nav-previous action-element"
            data-x="164"
            data-y="52"
            data-visible="0"
          >
          ...
          <button
            ...
            class="action-button project-slider__nav-next action-element"
            data-x="164"
            data-y="52"
            data-visible="0"
          >
        ...
        timeline
          ...
          .staggerFromTo(
            this.$refs.slider.querySelectorAll(
              ".project-slider__element-source"
            ),
            3,
            {
              scale: 1.25
