...
const initStage3 = ({ materials }) => {
  ...
  const geometry2 = new THREE.BoxBufferGeometry(6, 6, 6);
  ...
  const geometry3 = new THREE.BoxBufferGeometry(4.5, 4.5, 4.5);
