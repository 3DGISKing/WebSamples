...
const initStage2 = ({ materials }) => {
  const geometry1 = new THREE.DodecahedronBufferGeometry(2.5);
  ...
  const geometry2 = new THREE.DodecahedronBufferGeometry(5);
  ...
  const geometry3 = new THREE.DodecahedronBufferGeometry(3);
  const mesh3 = new THREE.Mesh(geometry3, materials.default);
  mesh3.position.set(-2, 2, 3);
